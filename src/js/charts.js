...
class ExcelBlandAltmanChart {
  constructor(x, y, diffType, apsAbs, apsRel, chartDataRange, outputRange = "") {
    ...
    this.diffType = diffType; // 'abs' or 'rel'
  ...
  getMeanDifferenceData(minX, maxX, meanDiff) {
  ...
  getLimitOfAgreementData(minX, maxX, means, meanDiff, sdDiff) {
  ...
  getBlandAltmanApsData(minX, maxX, meanDiff, apsAbs, apsRel, diffType) {
  ...
  async createChart() {
    await Excel.run(async (context) => {
      ...
      meanDiffSeries.format.line.style = Excel.ChartLineStyle.continuous; // Set the line style to solid
      ...
      upperLimitSeries.format.line.style = Excel.ChartLineStyle.dot; // Set the line style to dashed
      ...
      lowerLimitSeries.format.line.style = Excel.ChartLineStyle.dot; // Set the line style to dot
      ...
      if (model.apsData !== null) {
        ...
        apsUpperSeries.format.line.style = Excel.ChartLineStyle.dash; // Set the line style to dashed
...
class ExcelRegressionChart {
  constructor(x, y, slope, intercept, apsAbs, apsRel, chartDataRange, outputRange = "") {
  ...
  getApsData(minX, maxX, apsAbs, apsRel) {
  ...
  async createChart() {
    await Excel.run(async (context) => {
      ...
      identitySeries.format.line.style = Excel.ChartLineStyle.continuous; // Set the line style to solid
      ...
      regressionSeries.format.line.style = Excel.ChartLineStyle.continuous; // Set the line style to solid
