...
export class UIStrings {
    private static EN = {
        ...
        "inf_box_cox": "Estimate the optimal value for lambda by defining a search space of possible values. The default is from -2 to +2 in steps of 0.01. For each lambda in the search space a Box-Cox transformation of the supplied data is performed. The value of lambda associdated with the best fit is selected. Two methods for assessing the optimal lambda are available. The default method performs a Shapiro-Wilk test for normality, and the second calculates the log likelihood value.",
        "lbl_input_range": "Input Range",
        "msg_input_range": "Must be a valid Excel range. e.g., A2:A26",
        "lbl_bc_method": "Parameter Estimation Method",
        "opt_sw": "Shapiro-Wilk Fit",
        "opt_mle": "Maximum Likelihood Fit",
        "lbl_lambda_search": "Lambda Search Space",
        "lbl_start": "Start",
        "lbl_end": "End",
        "lbl_step": "Step",
        "lbl_days": "Days",
        "lbl_runs": "Runs",
        "lbl_reps": "Replicates",
        "lbl_days_desc": "Number of days.",
        "lbl_runs_desc": "Number of runs per day.",
        "lbl_reps_desc": "Number of replicates per run.",
        "lbl_levels": "Levels",
        "lbl_layout_range": "Layout Range",
        "msg_layout_range": "Must be a valid Excel cell reference. e.g., A26",
        "inf_ref_int1": "Derive reference intervals using the non-parametric or robust estimator (Horn's biweight quantile) methods.",
        "inf_ref_int2": "The robust algorithm should only be used if the population is symmetric. If this algorithm is selected the add-in will check for skewness by calculating the adjusted Fisher-Pearson coefficient and display a warning if significant skewness is detected.",
        "lbl_ri_method": "Parameter Estimation Method",
        "opt_robust": "Robust",
        "opt_np": "Non-parametric",
        "lbl_ri_alpha": "Reference Limit Alpha",
        "tip_ri_alpha": "Default value is 0.05 for 95% confidence interval.",
        "lbl_ci_alpha": "Confidence Limits Alpha",
        "tip_ci_alpha": "Default value is 0.10 for 90% confidence interval.",
    }
