    ...
    await Excel.run(async (context) => {
      ...
      try {
        ...
        if (xData.size > 0) {
          ...
          // Run the regression
          let res: RegressionResults = doRegression(xArr, yArr, regressionType, ciMethod, errRatio);
          let data: any[][] = [];
          if (labelOutput) {
        ...
        <AccordionPanel>
          <Card>
            ...
            <div className={styles.field}>
              ...
              <Checkbox id="lbl-output" checked={labelOutput} onChange={toggleLabelOutput} />
            </div>
            <RangeInput
