...
export default function Precision(props: PrecisionProps) {
  ...
  function formatPrecisionForExcel(
    labels: string[],
    columnData: number[][]
  ): (string | number)[][] {
    let rangeValues: (string | number)[][] = [];
  ...
  return (
    <div className="container">
      <div>{props.uitext["inf_precision"]}</div>
      <div>
        <RangeInput
          label={props.uitext["lbl_days_range"]}
      ...
      <div>
        <RangeInput
          label={props.uitext["lbl_runs_range"]}
      ...
      <div>
        <RangeInput
          label={props.uitext["lbl_results_range"]}
      ...
      <div className={styles.field}>
        <Button appearance="primary" onClick={grubbsTestForOutliers}>
          {props.uitext["btn_grubb_test"]}
        </Button>
      </div>
      <div>
        <RangeInput
      ...
      <div className={styles.field}>
        <Button appearance="primary" onClick={runANOVA}>
