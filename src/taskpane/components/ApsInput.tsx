...
const RangeInput: React.FC<RangeInputProps> = (props: RangeInputProps) => {
    ...
    return (
        ...
        validationMessage={validationMessage}>
            ...
            <Tooltip content="Excel cell reference or APS absolute value" relationship="label">
            <Input
                value={props.rangeValue}
                className="mb-3"
                pattern="^(?:(\d+\x2E?\d*)?(([a-zA-Z\d\x5F\x2D]*\x21)?(\$?[A-Z]{1,3}\$?[1-9]{1}\d{0,6})(:\$?[A-Z]{1,3}\$?[1-9]{1}\d{0,6})?)?)$"
