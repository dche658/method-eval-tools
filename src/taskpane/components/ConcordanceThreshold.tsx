  ...
  return (
    <div className={styles.container}>
      <div className={styles.gridcontainer}>
        ...
        <div className={styles.griddiv}>
          <Input
            value={props.xThreshold0}
            onChange={handleXThreshold0Change}
        ...
        <div className={styles.griddiv}>
          <Input
            value={props.yThreshold0}
            onChange={handleYThreshold0Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.xThreshold1}
            onChange={handleXThreshold1Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.yThreshold1}
            onChange={handleYThreshold1Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.xThreshold2}
            onChange={handleXThreshold2Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.yThreshold2}
            onChange={handleYThreshold2Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.xThreshold3}
            onChange={handleXThreshold3Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
        <div className={styles.griddiv}>
          <Input
            value={props.yThreshold3}
            onChange={handleYThreshold3Change}
            className={styles.inputfield}
            type="number"
          />
        </div>
