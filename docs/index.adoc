...
Let stem:[p_{ij}] be the proportion of subjects placed in the __i,j__th cell, and the proportion is
simply calculated as the tabulated value divided by the total. Let
